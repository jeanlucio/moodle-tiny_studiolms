...
/**
 * External function: generate a mind map structure via AI.
 *
...
/**
 * Generates a mind map node structure from a topic description using an LLM.
 *
 * @package    tiny_studiolms
 * @copyright  2026 Jean Lúcio
 * @license    https://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class generate_mindmap extends external_api {
    /**
    ...
    public static function execute(string $topic): array {
        ...
        return ['topic' => $result['topic'], 'branches' => $result['branches']];
    }
    ...
    public static function execute_returns(): external_single_structure {
        return new external_single_structure([
            'topic'    => new external_value(PARAM_TEXT, 'Central topic of the mind map'),
            'branches' => new external_value(PARAM_RAW, 'JSON-encoded branches array'),
        ]);
    }
}
