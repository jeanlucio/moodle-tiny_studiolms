...
/**
 * External function: generate_infographic_comparison.
 *
...
/**
 * Generates a comparison infographic via a configured LLM provider.
 */
class generate_infographic_comparison extends external_api {
    /**
    ...
    public static function execute_returns(): external_single_structure {
        return new external_single_structure([
            ...
            'col1'     => new external_value(PARAM_TEXT, 'Name of the first column/option.'),
            'col2'     => new external_value(PARAM_TEXT, 'Name of the second column/option.'),
            'items'    => new external_value(PARAM_RAW, 'JSON-encoded array of comparison items.'),
