...
/**
 * Event fired when a StudioLMS template is updated.
 *
...
/**
 * Fired when a user updates an existing layout template.
 */
class template_updated extends \core\event\base {
    ...
    public static function get_name(): string {
        return get_string('event_template_updated', 'tiny_studiolms');
    }
    ...
    public function get_description(): string {
        return "The user with id '{$this->userid}' updated the StudioLMS template with id '{$this->objectid}'.";
    }
